...
<body>
	<form action="<%=basePath%>servlet/NoticeAddServlet" method="post"
		name="form1" onsubmit="return checkForm('form1');">
		<table class=editTable cellSpacing=1 cellPadding=0 width="100%"
			align=center border=0>
			<tr class=editHeaderTr>
				<td class=editHeaderTd colSpan=7>请输入公告内容</td>
			</tr>
			<tr>
				<td bgcolor="#FFFDF0">
					<div align="center">公告员工：</div></td>
				...
				<td bgcolor="#FFFDF0">
					<div align="center">截止时间：</div></td>
				<td colspan="3" bgcolor="#FFFFFF"><input type="text"
					style="width: 145px" name="noticeEndTime" check_str="截止时间"
			...
			<tr>
				...
				<td colspan="5" bgcolor="#FFFFFF"><textarea rows="10"
						name="noticeContent" style="width: 100%; resize: none;"
						check_str="公告内容"></textarea></td>
			</tr>
		...
		<table class=editTable cellSpacing=1 cellPadding=0 width="100%"
			...
			<tr bgcolor="#ECF3FD">
				<td width="25%"></td>
				<td width="17%"><input type="submit" name="submit" value="发布">
				</td>
