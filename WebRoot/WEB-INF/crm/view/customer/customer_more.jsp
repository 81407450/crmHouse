...
<body>
	<form action=" servlet/CustomerUpdateServlet " method="get"
		...
		<table class=editTable cellSpacing=1 cellPadding=0 width="100%"
			...
			<tr class=editHeaderTr>
				<td class=editHeaderTd colSpan=7>客户详细信息<input type="hidden"
					name="customerId" value="<%=customerInfo.getCustomerId()%>" />
				</td>
			</tr>
			<tr>
				...
				<td width="14%" bgcolor="#FFFDF0"><div align="center">客户来源：</div>
				</td>
				<td width="41%" colspan="3" align="center" bgcolor="#FFFFFF"><%=customerInfo.getCustomerSource()%></td>
			</tr>
			<tr>
				<td bgcolor="#FFFDF0"><div align="center">客户姓名：</div>
				</td>
		...
		<table class=editTable cellSpacing=1 cellPadding=0 width="100%"
			...
			<tr bgcolor="#ECF3FD">
				<td width="36%"></td>
				<td width="17%"><input type="submit" name="submit" value="编辑">
				</td>
