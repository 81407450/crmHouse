...
<body>
	<form action="<%=basePath%>servlet/CustomerUpdateServlet" method="post"
		...
		<table class=editTable cellSpacing=1 cellPadding=0 width="100%"
			...
			<tr class=editHeaderTr>
				<td class=editHeaderTd colSpan=7>请修改客户信息 <input type="hidden"
					name="customerId" value="<%=customerInfo.getCustomerId()%>" /></td>
			</tr>
			<tr>
				<td width="12%" bgcolor="#FFFDF0"><div align="center">负责员工：</div>
				</td>
				<td colspan="3" bgcolor="#FFFFFF"><select
					name="customerForUser" style=" width: 145px">
						<%
						...
						%>
						<option value="<%=userInfo.getUserId()%>"
				...
				<td width="12%" bgcolor="#FFFDF0">
					<div align="center">客户来源：</div></td>
				<td width="37%" colspan="3" bgcolor="#FFFFFF"><select
					name="customerSource" style="width: 145px">
						<%
			...
			<tr>
				...
				<td colspan="3" bgcolor="#FFFFFF"><input type="text"
					style=" width: 145px" disabled="disabled" name="customerName"
					value="<%=customerInfo.getCustomerName()%>"></td>
				<td bgcolor="#FFFDF0">
					<div align="center">客户状态：</div></td>
				<td colspan="3" bgcolor="#FFFFFF"><select
					name="customerCondition" style="width: 145px">
						<%
						...
						<option value="<%=conditionInfo.getConditionId()%>"
							<%if (customerInfo.getConditionId() == conditionInfo
						.getConditionId()) {%>
			...
			<tr>
				...
				<td bgcolor="#FFFDF0">
					<div align="center">客户类型：</div></td>
				<td colspan="3" bgcolor="#FFFFFF"><select name="customerType"
					style="width: 145px">
						<%
			...
			<tr>
				...
				<td colspan="3" bgcolor="#FFFFFF"><input type="text"
					...
					&nbsp;</td>
				<td bgcolor="#FFFDF0">
					<div align="center">客户手机：</div></td>
				<td colspan="3" bgcolor="#FFFFFF"><input type="text"
					style=" width: 145px" valid="regexp"
					regexp="^1[3|4|5|8][0-9]\d{8}$" errmsg="请输入正确的手机号码!"
					name="customerMobile" value="<%=customerInfo.getCustomerMobile()%>">
					&nbsp;</td>
			</tr>

			<tr>
				<td bgcolor="#FFFDF0">
					<div align="center">客户QQ：</div></td>
				<td colspan="3" bgcolor="#FFFFFF"><input type="text"
					style=" width: 145px" valid="isQQ" errmsg="请输入正确的QQ号码!"
					name="customerQq" value="<%=customerInfo.getCustomerQq()%>">
					&nbsp;</td>
				<td bgcolor="#FFFDF0">
					<div align="center">客户地址：</div></td>
				<td colspan="3" bgcolor="#FFFFFF"><input type="text"
			...
			<tr>
				...
				<td colspan="6" bgcolor="#FFFFFF"><textarea rows="10"
						name="customerRemark" style="width: 100%; resize: none;">
		...
		<table class=editTable cellSpacing=1 cellPadding=0 width="100%"
			...
			<tr bgcolor="#ECF3FD">
				<td width="36%"></td>
				<td width="17%"><input type="submit" name="submit" value="提交">
				</td>
