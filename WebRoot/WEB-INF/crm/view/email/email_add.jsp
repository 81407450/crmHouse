...
<body onload=startclock()>
	<form action="<%=basePath%>servlet/EmailAddServlet" id="form2"
		method="post" name="form2" onsubmit="return checkForm('form2');">
		<table class=editTable cellSpacing=1 cellPadding=0 width="100%"
			align=center border=0>
			<tr class=editHeaderTr>
				<td class=editHeaderTd colSpan=7>请输入邮件的详细信息</td>
			</tr>
			...
			<tr>
				...
				<td colspan="3" bgcolor="#FFFFFF"><select name="addressee"
					style=" width: 580px">
						...
						%>
						<option value="<%=customerInfo.getCustomerId()%>"><%=customerInfo.getCustomerName()%></option>
						<%
							}
						%>
				</select>&nbsp;</td>
			...
			<tr>
				...
				<td colspan="3" bgcolor="#FFFFFF"><input type="text"
					style="width:580px" check_str="主题" name="emailTheme">
				</td>
			</tr>
			...
			<tr>
				...
				<td colspan="3" bgcolor="#FFFFFF"><textarea check_str="内容"
						...
						style="width:578px; resize:none; height:300px;"></textarea></td>
			</tr>
			<tr>
