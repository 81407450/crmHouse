		...
		<table class=editTable cellSpacing=1 cellPadding=0 width="100%"
			...
			<tr class=editHeaderTr>
				<td class=editHeaderTd colSpan=7 style="height: 49px">请输入详细信息 <input
					type="hidden" name="careId" value="${careInfo.careId }"
			...
			<tr>
				<td bgcolor="#FFFDF0" style="width: 13%">
					<div align="center">关怀时间：</div></td>
				<td colspan="3" bgcolor="#FFFFFF"><input type="text"
					style="width: 145px" disabled="disabled" name="careTime"
					value="${careInfo.careTime }"> &nbsp;</td>
				<td bgcolor="#FFFDF0" style="width: 13%">
					<div align="center">下次关怀时间：</div></td>
				<td colspan="3" bgcolor="#FFFFFF"><input type="text"
			...
			<tr>
				<td bgcolor="#FFFDF0" style="width: 13%">
					<div align="center">是谁关怀的：</div></td>
				<td colspan="3" bgcolor="#FFFFFF"><input type="text"
					style="width: 145px" maxlength="20" name="carePeople"
					value="${careInfo.carePeople }"> &nbsp;</td>
				<td bgcolor="#FFFDF0" style="width: 13%">
					<div align="center">关怀方式：</div></td>
				<td colspan="3" bgcolor="#FFFFFF"><select name="careWay"
					value="${careInfo.careWay }" style="width: 145px">
						<option <%if (careInfo.getCareWay().equals("发短信")) {%>
							selected="selected" <%}%>>发短信</option>
						<option <%if (careInfo.getCareWay().equals("送礼品")) {%>
							selected="selected" <%}%>>送礼品</option>
						<option <%if (careInfo.getCareWay().equals("电话问候")) {%>
							selected="selected" <%}%>>电话问候</option>
						<option <%if (careInfo.getCareWay().equals("上门拜访")) {%>
							selected="selected" <%}%>>上门拜访</option>
			...
			<tr>
				<td bgcolor="#FFFDF0" style="width: 13%">
					<div align="center">关怀备注：</div></td>
				<td colspan="7" bgcolor="#FFFFFF"><textarea name="careRemark"
						style="width: 100%; resize: none;" rows="10">${careInfo.careRemark }</textarea>
				</td>
			</tr>
		</table>
		<table class=editTable cellSpacing=1 cellPadding=0 width="100%"
			...
			<tr bgcolor="#ECF3FD">
				<td width="40%"></td>
				<td width="10%"><input type="submit" name="submit" value="提交">
				</td>
