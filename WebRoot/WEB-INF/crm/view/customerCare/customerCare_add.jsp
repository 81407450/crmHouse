...
<body>
	<form action="<%=basePath%>servlet/CustomerCareAddServlet"
		...
		<table class=editTable cellSpacing=1 cellPadding=0 width="100%"
			...
			<tr>
				...
				<td colspan="3" bgcolor="#FFFFFF"><select name="customerId"
					style="width: 145px">
						...
						%>
						<option value="<%=de.getCustomerId()%>"><%=de.getCustomerName()%></option>
						<%
							}
							}
						%>
			...
			<tr>
				...
				<td colspan="3" bgcolor="#FFFFFF"><input type="text"
					style="width: 145px" name="careNexttime" check_str="下次关怀时间"
			...
			<tr>
				...
				<td colspan="5" bgcolor="#FFFFFF"><textarea name="careRemark"
		...
		<table class=editTable cellSpacing=1 cellPadding=0 width="100%"
			...
			<tr bgcolor="#ECF3FD">
				<td width="40%"></td>
				<td width="10%"><input type="submit" name="submit" value="添加">
				</td>
