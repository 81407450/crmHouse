...
<body>
	<form action="<%=basePath%>servlet/LInkManUpdateServlet " method="post"
		...
		<table class=editTable cellSpacing=1 cellPadding=0 width="100%"
			...
			<tr class=editHeaderTr>
				<td class=editHeaderTd colSpan=7 style="height: 49px">请输入详细信息<input
					type="hidden" name="linkManId"
					value="<%=linkManInfo.getLinkmanId()%>" /></td>

			</tr>
			<tr>
				<td bgcolor="#FFFDF0">
					<div align="center">关联客户：</div></td>
				<td colspan="3" bgcolor="#FFFFFF"><select name="userName"
					style="width: 145px">
						...
						<option value="<%=customerInfo.getCustomerId()%>"
							<%if (customerInfo.getCustomerId() == linkManInfo
						.getCoustomerId()) {%>
				...
				<td bgcolor="#FFFDF0" style="width: 13%">
					<div align="center">联系人名称：</div></td>
				<td colspan="3" bgcolor="#FFFFFF"><input type="text"
					style="width: 145px" name="linkManName" disabled="disabled"
					value="<%=linkManInfo.getLinkmanName()%>"> &nbsp;</td>
			</tr>


			<tr>
				<td bgcolor="#FFFDF0">
					<div align="center">联系人性别：</div></td>
				<td colspan="3" bgcolor="#FFFFFF"><input type="radio"
					name="LinkManSex" value="男"
					<%if (linkManInfo.getLinkmanSex().equals("男")) {%>
					checked="checked" <%}%> /> 男&nbsp;&nbsp; <input type="radio"
					name="LinkManSex" value="女"
					<%if (linkManInfo.getLinkmanSex().equals("女")) {%>
					checked="checked" <%}%> /> 女 <br /></td>
				<td bgcolor="#FFFDF0" style="width: 13%">
					<div align="center">联系人年龄：</div></td>
				<td colspan="3" bgcolor="#FFFFFF"><input type="text"
					style="width: 145px" name="linkManAge" check_str="联系人年龄"
			...
			<tr>
				<td bgcolor="#FFFDF0" style="width: 13%">
					<div align="center">联系职位：</div></td>
				<td colspan="3" bgcolor="#FFFFFF"><input type="text"
					style="width: 145px" name="linkManJob"
					value="<%=linkManInfo.getLinkmanJob()%>"></td>
				<td bgcolor="#FFFDF0" style="width: 13%">
					<div align="center">联系人手机：</div></td>
				<td colspan="3" bgcolor="#FFFFFF"><input type="text"
					style="width: 145px" name="linkManMobile"
					value="<%=linkManInfo.getLinkmanMobile()%>"> &nbsp;</td>
			</tr>

			<tr>
				<td bgcolor="#FFFDF0" style="width: 13%">
					<div align="center">与客户关系：</div></td>
				<td colspan="7" bgcolor="#FFFFFF"><input type="text"
					style="width: 145px" name="linkManRelation"
					value="<%=linkManInfo.getLinkmanRelation()%>"> &nbsp;</td>
			</tr>
		</table>
		<table class=editTable cellSpacing=1 cellPadding=0 width="100%"
			align=center border=0>
